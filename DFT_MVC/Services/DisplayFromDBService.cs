namespace DFT_MVC.Services
{
    ...
    public class DisplayFromDBService 
    {
        ...
        public async Task GetData()
        {
            ...
            Images = await _context.ImageDatas!.ToListAsync();
        }

        public async Task<IEnumerable<ImageData>> GetImages() => Images = await _context.ImageDatas!.ToListAsync();

        public async Task<IEnumerable<Category>> GetCategories() => Categories = await _context.Categories.ToListAsync();

        //public async Task<ImageData> GetOneImage(int id)
        //{
        //    var image = await _context.ImageDatas.FirstOrDefaultAsync(i => i.CategoryId == id);
